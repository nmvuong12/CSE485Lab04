        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="{{route('readers.create')}}" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Thêm độc giả</span></a>
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>{{ $reader->phone }}</td>
                    <td>
                        <a href="{{route('readers.edit',$reader->id)}}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                        ...
                        <div class="modal-content">
                            <form action="{{route('readers.destroy',$reader->id)}}" method ="post">
                                ...
                                <div class="modal-body">
                                    <p>Bạn chắc muốn xóa độc giả này ?</p>
                                </div>
